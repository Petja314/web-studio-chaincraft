...
import {chroma, ScrollTrigger, SplitText} from "../../plugins";
import SiteLogoWhite1 from "../../../public/assets/imgs/logo/CCRAFTLOGO.svg";
        ...
        <div className="footer__top-3">
          <div className="footer__top-wrapper-3">
            <div className="footer__logo-3 pt-120">
              ...
              />
              <p>
                Our mission is to help your business grow faster with the latest technologies.
              </p>
            </div>
