...
import Service11 from "../../../public/assets/imgs/service/development.png";
import Service12 from "../../../public/assets/imgs/service/seo.png";
import Service13 from "../../../public/assets/imgs/service/ecommerce.png";
import Service14 from "../../../public/assets/imgs/service/advert.png";
          ...
          <div className="row">
            ...
            <div className="col-xxl-5 col-xl-5 col-lg-5 col-md-5">
              <div className="service__top-text text-anim">
                <p>
                  With each of our clients, we find an approach and <br/>
                  <span>
                     develop individual solutions corresponding to their unique needs and goals.
                  </span>
                </p>
              </div>
            </div>
                ...
                <div className="service__list" ref={serviceList}>
                  ...
                  >
                    <div className="service__item animation_home1_service">
                      ...
                      <div className="service__text">
                        <p>
                          Development of custom websites and mobile applications, with easy-to-use features and secure online payment options.
                        </p>
                      </div>
                  ...
                  >
                    <div className="service__item  animation_home1_service">
                      ...
                      <div className="service__text">
                        <p>
                          Improving your website’s visibility on search engines to attract more visitors and grow your online presence.
                        </p>
                      </div>
                      <div className="service__link">
                        <p>
                  ...
                  >
                    <div className="service__item  animation_home1_service">
                      ...
                      <div className="service__text">
                        <p>
                          Creating online stores with user-friendly shopping experiences.
                        </p>
                      </div>
                      <div className="service__link">
                        <p>
                  ...
                  >
                    <div className="service__item  animation_home1_service">
                      ...
                      <div className="service__text">
                        <p>
                          Promoting your brand online through various channels to reach a wider audience.
                        </p>
                      </div>
                      <div className="service__link">
                        <p>
                  ...
                  >
                    <div className="service__item  animation_home1_service">
                      ...
                      <div className="service__text">
                        <p>
                          Creating a unique design that reflects your brand and enhances user experience.
                        </p>
                      </div>
                      <div className="service__link">
                        <p>
